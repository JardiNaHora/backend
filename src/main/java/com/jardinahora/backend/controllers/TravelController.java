...
public class TravelController {
    ...
    public ResponseEntity<Object> createTravel(@RequestBody @Valid TravelDTO travelDTO) {
        ...
        try {
            applyTravelDTO(travelDTO, travelModel);
    ...
    private void applyTravelDTO(TravelDTO travelDTO, Travel travelModel) {
    ...
    private Date parseTime(String time) {
        ...
        return Date.from(localTime.atDate(LocalDate.EPOCH).atZone(SYSTEM_ZONE).toInstant());
    }

    private String formatDate(Date date) {
        return DATE_FORMAT.format(date.toInstant().atZone(SYSTEM_ZONE).toLocalDate());
    }
