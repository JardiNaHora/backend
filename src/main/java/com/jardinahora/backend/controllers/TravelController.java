...
public class TravelController {
    ...
    private static final LocalDate TIME_REFERENCE_DATE = LocalDate.of(1970, 1, 1);
    ...
    public ResponseEntity<Object> createTravel(@RequestBody @Valid TravelDTO travelDTO) {
        try {
            ...
            copyProperties(travelDTO, travelModel);
    ...
    private void copyProperties(TravelDTO travelDTO, Travel travelModel) {
    ...
    private Date parseDate(String value) {
        return Date.from(LocalDate.parse(value, DATE_FORMATTER)
                .atStartOfDay(ZoneId.systemDefault())
                .toInstant());
    }

    private Date parseTime(String value) {
        return Date.from(LocalTime.parse(value, TIME_FORMATTER)
                .atDate(TIME_REFERENCE_DATE)
