...
public class TravelController {
    ...
    public ResponseEntity<Object> createTravel(@RequestBody @Valid TravelDTO travelDTO) {
        ...
        try {
            ...
            return invalidDateTimeResponse();
        }
    ...
    private void copyDtoToTravel(TravelDTO travelDTO, Travel travelModel) {
        Date parsedDate = parseDate(travelDTO.date());
        Time parsedStartTime = parseTime(travelDTO.startTime());
        Time parsedEndTime = parseTime(travelDTO.endTime());

        travelModel.setDriver(travelDTO.driver());
        travelModel.setVehicle(travelDTO.vehicle());
        travelModel.setDate(parsedDate);
        travelModel.setStartTime(parsedStartTime);
        travelModel.setEndTime(parsedEndTime);
    ...
    private ResponseEntity<Object> invalidDateTimeResponse() {
