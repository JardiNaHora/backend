...
public class TravelController {
    ...
    private void copyTravelProperties(TravelDTO travelDTO, Travel travelModel) {
    ...
    private Date parseDate(String date) {
        ...
        return Date.from(parsedDate.atStartOfDay(ZONE_ID).toInstant());
    }

    private Date parseTime(String time) {
        LocalTime parsedTime = LocalTime.parse(time, TIME_FORMATTER);
        return Date.from(parsedTime.atDate(LocalDate.EPOCH).atZone(ZONE_ID).toInstant());
    }
