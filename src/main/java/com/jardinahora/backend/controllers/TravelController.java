...
public class TravelController {
    ...
    public ResponseEntity<Object> createTravel(@RequestBody @Valid TravelDTO travelDTO) {
        try {
            var travelModel = buildTravel(travelDTO, new Travel());
    ...
    public ResponseEntity<Object> updateTravel(@PathVariable(value = "id") UUID id,
        ...
        try {
            buildTravel(travelDTO, travelModel);
    ...
    private Travel buildTravel(TravelDTO travelDTO, Travel travelModel) {
    ...
    private Date parseTime(String value) {
        ...
        return Date.from(time.atDate(LocalDate.EPOCH).atZone(SYSTEM_ZONE).toInstant());
    }

    private String formatDate(Date value) {
        return value.toInstant().atZone(SYSTEM_ZONE).toLocalDate().format(DATE_FORMATTER);
    }
