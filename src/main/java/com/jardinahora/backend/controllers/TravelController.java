...
public class TravelController {
    ...
    private static void copyTravelDTOToModel(TravelDTO travelDTO, Travel travelModel) {
        ...
        travelModel.setStartTime(toDate(LocalDateTime.of(travelDate, LocalTime.parse(travelDTO.startTime(), TIME_FORMAT))));
        travelModel.setEndTime(toDate(LocalDateTime.of(travelDate, LocalTime.parse(travelDTO.endTime(), TIME_FORMAT))));
    }

    private static Date parseDate(String date) {
        return toDate(LocalDate.parse(date, DATE_FORMAT).atStartOfDay());
    }

    private static String formatDate(Date date) {
        return LocalDateTime.ofInstant(date.toInstant(), DEFAULT_ZONE).toLocalDate().format(DATE_FORMAT);
    }
