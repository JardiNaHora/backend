...
public class TravelController {
    ...
    public ResponseEntity<Object> createTravel(@RequestBody @Valid TravelDTO travelDTO) {
        try {
            var travelModel = buildTravelFromDto(travelDTO, new Travel());
    ...
    public ResponseEntity<Object> updateTravel(@PathVariable(value = "id") UUID id,
        ...
        try {
            var travelModel = buildTravelFromDto(travelDTO, travel0.get());
    ...
    private Travel buildTravelFromDto(TravelDTO travelDTO, Travel travelModel) {
