...
public class TravelController {
    ...
    public ResponseEntity<Object> createTravel(@RequestBody @Valid TravelDTO travelDTO) {
        ...
        try {
            applyDtoToTravel(travelDTO, travelModel);
    ...
    private void applyDtoToTravel(TravelDTO travelDTO, Travel travelModel) {
    ...
    private Date parseTime(String time) {
        ...
        return Date.from(localTime.atDate(LocalDate.EPOCH).atZone(DEFAULT_ZONE).toInstant());
    }

    private String formatDate(Date date) {
        return date.toInstant().atZone(DEFAULT_ZONE).toLocalDate().format(DATE_FORMATTER);
    }
