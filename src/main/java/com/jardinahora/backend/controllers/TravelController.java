...
public class TravelController {
    ...
    private Travel toTravel(TravelDTO travelDTO, Travel travelModel) {
    ...
    private Date parseTime(String value) {
        ...
        return Date.from(localTime.atDate(LocalDate.EPOCH).atZone(ZONE_ID).toInstant());
    }

    private String formatDate(Date value) {
        return value.toInstant().atZone(ZONE_ID).toLocalDate().format(DATE_FORMATTER);
    }
