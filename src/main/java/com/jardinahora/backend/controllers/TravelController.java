...
public class TravelController {
    ...
    public ResponseEntity<Object> createTravel(@RequestBody @Valid TravelDTO travelDTO) {
        try {
            Travel travelModel = populateTravel(new Travel(), travelDTO);
    ...
    public ResponseEntity<Object> updateTravel(@PathVariable(value = "id") UUID id,
        ...
        try {
            populateTravel(travelModel, travelDTO);
    ...
    private Travel populateTravel(Travel travel, TravelDTO travelDTO) {
    ...
    private Date parseTime(String time) {
        ...
        return Date.from(localTime.atDate(TIME_ANCHOR_DATE).atZone(DEFAULT_ZONE).toInstant());
    }
