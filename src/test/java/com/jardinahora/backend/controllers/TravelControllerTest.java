...
class TravelControllerTest {
    ...
    void createTravelParsesAndPersistsDateFields() {
        ...
        assertThat(toLocalDate(savedTravel.getDate())).isEqualTo(LocalDate.of(2026, 5, 14));
    ...
    @Test
    void createTravelRejectsInvalidDateWithoutPersisting() {
        TravelDTO travelDTO = new TravelDTO(
                "Motorista",
                "Van 01",
                "2026-02-31",
    ...
    private LocalTime toLocalTime(Date date) {
        return date.toInstant().atZone(SYSTEM_ZONE).toLocalTime();
    }
}
